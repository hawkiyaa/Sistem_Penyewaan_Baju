...
<body>
    <div class="container">
                ...
                <tr>
                    ...
                    <td>
                        <div style="display: flex; justify-content: center;">
                            <a href="edit_baju.php?id=<?= $data['id_baju'] ?>" class="action-button">Edit</a>
                            <a href="hapus_baju.php?id=<?= $data['id_baju'] ?>" class="action-button" onclick="return confirm('Yakin ingin menghapus data?')">Hapus</a>
                        </div>
                    </td>
                </tr>
            <?php endwhile; ?>
        ...
        <div class="button-container">
            <a href="tambah_baju.php"><button type="button">Tambah Baju</button></a>
