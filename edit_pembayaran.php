...
if (isset($_POST['edit'])) {
    ...
    $query = "UPDATE pembayaran SET id_penyewaan='$id_penyewaan', jumlah_pembayaran='$jumlah_pembayaran', metode_pembayaran='$metode_pembayaran', status='$status' WHERE id_pembayaran='$id_pembayaran'";
    ...
    <div class="container">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" name="id_penyewaan" value="<?= $data['id_penyewaan'] ?>" required>
            </div>
            <div class="form-group">
                <label>Jumlah Pembayaran:</label>
                <input type="number" name="jumlah_pembayaran" step="0.01" value="<?= $data['jumlah_pembayaran'] ?>" required>
            </div>
            <div class="form-group">
                <label>Metode Pembayaran:</label>
                <input type="text" name="metode_pembayaran" value="<?= $data['metode_pembayaran'] ?>" required>
            </div>
            <div class="form-group">
                <label>Status:</label>
